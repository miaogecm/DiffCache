...
use ndarray::{s, Array, Array2, Array4, ArrayView, ArrayView2, ArrayView3, Data, Dimension, ShapeBuilder};
use numpy::{PyArray3, PyArray4, PyReadonlyArray3, IntoPyArray};
...
#[pymodule]
fn diffcache_cpu(_py: Python, m: &Bound<'_, PyModule>) -> PyResult<()> {
